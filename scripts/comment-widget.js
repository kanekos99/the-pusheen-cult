...
const s_formId = "1FAIpQLSdj_M8bLWr639_h2dKry8mL0e5h55AYDSdjNP8gZq3W8jqzcQ";
const s_nameId = "751862708";
const s_websiteId = "1574095203";
const s_textId = "369848396";
const s_pageId = "625142370";
const s_replyId = "2042232423";
...
const s_widgetTitle = "Leave a Reply";
const s_nameFieldLabel = "Name (required)";
const s_websiteFieldLabel = "Website";
const s_textFieldLabel = "Comments (required)";
const s_submitButtonLabel = "Submit";
const s_loadingText = "";
const s_noCommentsText = "";
const s_closedCommentsText = "";
...
function createComment(data) {
  ...
  commentHeader.className = "c-comment-header";
